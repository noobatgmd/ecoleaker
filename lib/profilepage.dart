...
class _ProfileSettingsPageState extends State<ProfileSettingsPage>
  ...
  TextEditingController statusNoController = TextEditingController();
    ...
    if (user != null) {
      try {
        ...
        if (doc.exists) {
          ...
          statusNoController.text = data['admNo'] ?? '';
          ...
          await prefs.setString('admNo', statusNoController.text);
          if (base64Image != null) {
            await prefs.setString('profileImageBase64', base64Image);
          }
        } else {
          ...
          statusNoController.text = prefs.getString('admNo') ?? '';
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xFF4A90E2), Color(0xFF70B1F8)],
                  ),
                ),
                child: Row(
                  children: [
